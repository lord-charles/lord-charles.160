...
Thank you.`;
    ...
    const addUserToMikrotik = async ({
      ...
      let config = {
        method: "post",
        maxBodyLength: Infinity,
        url: "http://jp-1.hostddns.us:12639/rest/ip/hotspot/user/add",
        headers: {
          "Content-Type": "application/json",
...
const checkVoucherBalance = async (api_ref, account) => {
  try {
    const response = await axios.get(
      `http://jp-1.hostddns.us:12639/rest/ip/hotspot/user?name=${api_ref}`,
      {
        headers: {
          "Content-Type": "application/json",
          Authorization: "Basic YWRtaW46MDI2MTQ=",
...
const validateVoucher = async (req, res) => {
  try {
    ...
    const response = await axios.get(
      `http://jp-1.hostddns.us:12639/rest/ip/hotspot/user?name=${voucher}`,
      {
        headers: {
          "Content-Type": "application/json",
          Authorization: "Basic YWRtaW46MDI2MTQ=",
...
const removeActiveSessions = async (req, res) => {
  try {
    const { voucher } = req.body;
    const response = await axios.get(
      `http://jp-1.hostddns.us:12639/rest/ip/hotspot/active?user=${voucher}`,
      {
        headers: {
          "Content-Type": "application/json",
          Authorization: "Basic YWRtaW46MDI2MTQ=",
    ...
    if (response.data.length >= 1) {
      ...
      let config = {
        method: "post",
        maxBodyLength: Infinity,
        url: "http://jp-1.hostddns.us:12639/rest/ip/hotspot/active/remove",
        headers: {
          "Content-Type": "application/json",
          Authorization: "Basic YWRtaW46MDI2MTQ=",
        },
